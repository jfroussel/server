...
module.exports = (expressServer) => {
    ...
    expressServer.post("/reset-password", AuthController.resetPassword)
    ...
    // Newsletter
    expressServer.post("/subscribe", AuthController.subscribe)
    expressServer.post("/unsubscribe", AuthController.unSubscribe)
}